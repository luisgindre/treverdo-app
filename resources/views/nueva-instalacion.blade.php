            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="bg-gray-200 bg-opacity-25 pb-60">
                    <div class="flex justify-center">
                        <form action="{{ route('crearCliente') }}" method="POST" x-data="{ campos: [] }">
                            @csrf
                            <div class="px-6 flex flex-col">
                                ...
                                <div class="md:grid md:grid-cols-2 gap-8">
                                    <div>
                                        <label class="block mt-4 text-gray-600" for="referenciaCatastral">Referencia Catastral</label>
                                        <input class="w-full" type="text" id="referenciaCatastral" name="referenciaCatastral">
                                    </div>
                                    <div>
                                ...
                                <div class="md:grid md:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <select class="w-full" name="TipoCultivo[]" id="TipoCultivo" multiple>
                                ...
                                <template x-for="(campo, index) in campos" :key="index">
                                    <input type="text" :name="'TipoCultivo[' + index + ']'" x-model="campo" />
                                </template>
                                    
                                <!-- Botón para agregar campos -->
                                <button type="button" @click="campos.push('')">Agregar Campo</button>
