<div class="flex justify-center gap-6 bg-gray-200 bg-opacity-25 p-20">
    <div class="flex justify-center items-center border-2 border-gray-200 w-60 h-60 bg-treverdo-200">
    ...
    <div class="flex justify-center items-center border-2 border-gray-200 w-60 h-60 bg-treverdo-700">
